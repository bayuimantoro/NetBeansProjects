...
public class jasper {
    ...
    private List<Map<String, ?>> fetchData() {
        ...
        String sql = "SELECT nim, nama, jk, prodi, kelas, nilai FROM tabelmhs";

        try (Connection con = koneksi.con; Statement st = con.createStatement(); ResultSet rs = st.executeQuery(sql)) {
