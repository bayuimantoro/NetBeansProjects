...
public class data_nilai extends javax.swing.JFrame {
    ...
    private void load_data() {
        Object header[] = { "NILAI", "MATA KULIAH", "GRADE", "SKS"};
        DefaultTableModel data = new DefaultTableModel(null, header);
        jTable1.setModel(data);
        String sql = "SELECT NILAI, MK, GRADE, SKS FROM tablee_nilai";
    ...
    public void input_data() {
        ...
        try {
            String sql = "INSERT INTO tablee_nilai values('" 
                    + jTextField1.getText()
                    + "','" + jTextField2.getText()
                    + "','" + jTextField3.getText()
                    + "','" + jTextField4.getText()
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        try{
            String sql_edit = "UPDATE tablee_nilai SET NILAI = '"
                    + jTextField2.getText()
                    + "', MATA KULIAH = '" + jTextField3.getText()
                    + "', GRADE = '" + jTextField4.getText()
                    + "' WHERE tablee_nilai = '" + jTextField1.getText()
                    + "'";            
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            st = koneksi.con.createStatement();
            String sql_delete = "DELETE FROM tablee_nilai WHERE NILAI = '"+jTextField1.getText()+"'";
