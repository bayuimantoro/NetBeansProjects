...
private void load_data() {
        ...
        String sql = "SELECT NIM, NAMA, KELAS, ANGKATAN, NO_HP, JK, PRODI, ALAMAT FROM formm";
        ...
        try {
            ...
            String sql = "INSERT INTO formm values('" + jTextField1.getText()
                    + "','" + jTextField2.getText()
                    + "','" + jTextField3.getText()
                    + "','" + jTextField4.getText()
                    + "','" + jTextField5.getText()
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String sql_edit = "UPDATE formm SET "
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            int response = JOptionPane.showConfirmDialog(null, "Apakah Anda yakin ingin menghapus data?",
                "Konfirmasi", JOptionPane.YES_NO_OPTION);
            st = koneksi.con.createStatement();
            String sql_hapus = "DELETE FROM formm WHERE NIM = '" + jTextField1.getText() + "'";
